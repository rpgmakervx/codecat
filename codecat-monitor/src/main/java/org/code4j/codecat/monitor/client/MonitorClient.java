package org.code4j.codecat.monitor.client;/**
 * Description : 
...
import org.code4j.codecat.monitor.util.DiskUtil;
...
//        System.out.println("END header ---------------");
    ...
    public static void main(String[] args) throws URISyntaxException, IOException {
        MonitorClient client = new MonitorClient(new InetSocketAddress("localhost",8080),"/tomcat.png");
